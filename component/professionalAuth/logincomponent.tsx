...
function LoginComponentP() {
  ...
  const accountLabel = isDelivery ? "delivery" : "professional";
            ...
            >
              ...
              <View style={[styles.card, {
                ...
                <TouchableOpacity
                  ...
                  accessibilityHint={`Signs you into your ${accountLabel} account`}
                ...
                <View style={styles.pillRow}>
                  {[
                    ...
                    ...(isDelivery
                      ...
                      : [{ label: "Delivery", route: "/logindelivery" }]),
                  ].map(({ label, route }) => (
                    <TouchableOpacity
                      key={label}
