...
export default function ClientLayout() {
  ...
  return (
    <Tabs
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ focused, color, size }) => {
          ...
          if (route.name === "homelayout") iconName = "home";
          else if (route.name === "chatlayout") iconName = "comment-dots";
          else if (route.name === "marketlayout") iconName = "shopping-cart";
          else if (route.name === "myjobLayout") iconName = "toolbox";
    ...
    >
      <Tabs.Screen name="homelayout" options={{ title: "Home" }} />
      <Tabs.Screen name="chatlayout" options={{ title: "Chat" }} />
      <Tabs.Screen name="marketlayout" options={{ title: "Market" }} />
      <Tabs.Screen name="myjobLayout" options={{ title: "My Job" }} />
    </Tabs>
  );
}
